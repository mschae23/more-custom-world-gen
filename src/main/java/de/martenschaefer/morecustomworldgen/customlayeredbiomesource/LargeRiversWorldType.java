...
public class LargeRiversWorldType extends GeneratorType {
    public LargeRiversWorldType() {
        super("morecustomworldgen.large_rivers");
        GeneratorType.VALUES.add(this);
    }

    @Override
    protected ChunkGenerator getChunkGenerator(Registry<Biome> biomeRegistry, Registry<ChunkGeneratorSettings> chunkGeneratorSettingsRegistry, long seed) {
        return new NoiseChunkGenerator(CustomLayeredBiomeSource.Preset.LARGE_RIVERS.getBiomeSource(biomeRegistry, seed),
