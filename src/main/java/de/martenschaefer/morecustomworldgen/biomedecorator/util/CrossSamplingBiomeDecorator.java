...
public abstract class CrossSamplingBiomeDecorator extends BiomeDecorator {
    ...
    public abstract RegistryKey<Biome> getBiome(LayerRandomnessSource random, RegistryKey<Biome> n, RegistryKey<Biome> e, RegistryKey<Biome> s, RegistryKey<Biome> w, RegistryKey<Biome> center);
}
