...
public record SimpleReplaceBiomeEntry(RegistryKey<Biome> comparingBiome, Chance chance, RegistryKey<Biome> biome) {
    public static final Codec<SimpleReplaceBiomeEntry> CODEC = RecordCodecBuilder.create(instance ->
        instance.group(
            ...
            RegistryKeys.BIOME_CODEC.fieldOf("biome").forGetter(SimpleReplaceBiomeEntry::biome)
