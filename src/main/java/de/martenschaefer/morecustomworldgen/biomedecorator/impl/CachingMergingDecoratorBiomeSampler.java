...
public class CachingMergingDecoratorBiomeSampler extends MergingDecoratorBiomeSampler {
    ...
    public CachingMergingDecoratorBiomeSampler(LayerRandomnessSource random, BiomeSampler parent, BiomeSampler parent2, MergingBiomeDecorator decorator, Object2ObjectLinkedOpenHashMap<BlockPos, BiomeContext> cache, int cacheCapacity) {
