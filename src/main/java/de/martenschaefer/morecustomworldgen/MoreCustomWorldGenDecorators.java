...
import de.martenschaefer.morecustomworldgen.decorator.RangeMaskDecoratorConfig;
...
public class MoreCustomWorldGenDecorators {
    ...
    public static final Decorator<RangeMaskDecoratorConfig> RANGE_MASK = register("range_mask", new RangeMaskDecorator(RangeMaskDecoratorConfig.CODEC));
